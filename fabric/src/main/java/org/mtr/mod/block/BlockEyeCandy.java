...
public class BlockEyeCandy extends BlockWaterloggable implements DirectionHelper, BlockWithEntity {
	...
	public BlockState getPlacementState2(ItemPlacementContext itemPlacementContext) {
		final BlockState state = super.getPlacementState2(itemPlacementContext);
		return (state == null ? getDefaultState2() : state).with(new Property<>(FACING.data), itemPlacementContext.getPlayerFacing().data);
	}
