...
public final class InitClient {
	...
	private static RegistryClient.ModelPredicateProvider checkItemPredicateTag() {
		return (itemStack, clientWorld, livingEntity) -> org.mtr.mapping.mapper.ItemStackNbtHelper.getTag(itemStack).contains(ItemBlockClickingBase.TAG_POS) ? 1 : 0;
	}
