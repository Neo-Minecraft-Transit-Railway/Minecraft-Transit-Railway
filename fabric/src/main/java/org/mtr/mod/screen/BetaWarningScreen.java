...
public class BetaWarningScreen extends ScreenExtension implements IGui, Utilities {
	...
	public void render(GraphicsHolder graphicsHolder, int mouseX, int mouseY, float delta) {
		...
		graphicsHolder.drawCenteredText("Minecraft Transit Railway " + Keys.MOD_VERSION, 0, 0, ARGB_WHITE);
		graphicsHolder.pop();
		...
		i = wrapAndRender(graphicsHolder, "- This is the Minecraft 1.21.11 Fabric port. Please report any bugs you find!", i + SQUARE_SIZE);
